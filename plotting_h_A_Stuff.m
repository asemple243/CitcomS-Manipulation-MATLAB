...
hold on
plot([1.5 1.7 1.9 2.0 2.3 2.5 2.7],[eff_n15amb135 eff_n17amb135 eff_n19amb135 eff_n20amb135 eff_n23amb135 eff_n25amb135 eff_n27amb135],'k')
...
plot([1.5 1.7 1.9 2.0 2.3 2.5 2.7],[eff_n15amb18 eff_n17amb18 eff_n19amb18 eff_n20amb18 eff_n23amb18 eff_n25amb18 eff_n27amb18],'k')
...
hold on
plot([1.5 1.7 1.9 2.0 2.3 2.5 2.7],[min_n15amb135 min_n17amb135 min_n19amb135 min_n20amb135 min_n23amb135 min_n25amb135 min_n27amb135],'k')
...
plot([1.5 1.7 1.9 2.0 2.3 2.5 2.7],[min_n15amb18 min_n17amb18 min_n19amb18 min_n20amb18 min_n23amb18 min_n25amb18 min_n27amb18],'k')
legend('h_A=.075','h_A=.090','h_A=.105','h_A=.12','h_A=.135')
xlabel('Power Law Dependence (n)')
...
hold on
plot([1.5 1.7 1.9 2.0 2.3 2.5 2.7],[have_n15amb135(end,3) have_n17amb135(end,3) have_n19amb135(end,3) have_n20amb135(end,3) have_n23amb135(end,3) have_n25amb135(end,3) have_n27amb135(end,3)],'y')
...
plot([1.5 1.7 1.9 2.0 2.3],[have_n15amb165(end,3) have_n17amb165(end,3) have_n19amb165(end,3) have_n20amb165(end,3) have_n23amb165(end,3)],'b')
plot([1.5 1.7 1.9 2.0 2.3 2.5 2.7],[have_n15amb18(end,3) have_n17amb18(end,3) have_n19amb18(end,3) have_n20amb18(end,3) have_n23amb18(end,3) have_n25amb18(end,3) have_n27amb18(end,3)],'m')
legend('h_A=.075','h_A=.090','h_A=.105','h_A=.12','h_A=.135')
...
hold on
plot([1.5 1.7 1.9 2.0 2.3 2.5 2.7],[UA_n15amb135/have_n15amb135(end,3) UA_n17amb135/have_n17amb135(end,3) UA_n19amb135/have_n19amb135(end,3) UA_n20amb135/have_n20amb135(end,3) UA_n23amb135/have_n23amb135(end,3) UA_n25amb135/have_n25amb135(end,3) UA_n27amb135/have_n27amb135(end,3)],'k')
...
plot([1.5 1.7 1.9 2.0 2.3],[UA_n15amb165/have_n15amb165(end,3) UA_n17amb165/have_n17amb165(end,3) UA_n19amb165/have_n19amb165(end,3) UA_n20amb165/have_n20amb165(end,3) UA_n23amb165/have_n23amb165(end,3)],'k')
plot([1.5 1.7 1.9 2.0 2.3 2.5 2.7],[UA_n15amb18/have_n15amb18(end,3) UA_n17amb18/have_n17amb18(end,3) UA_n19amb18/have_n19amb18(end,3) UA_n20amb18/have_n20amb18(end,3) UA_n23amb18/have_n23amb18(end,3) UA_n25amb18/have_n25amb18(end,3) UA_n27amb18/have_n27amb18(end,3)],'k')
legend('h_A=.075','h_A=.090','h_A=.105','h_A=.12','h_A=.135')
xlabel('Power Law Dependence (n)')
ylabel('UA/UL')
